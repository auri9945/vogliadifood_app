...
class AppColors{
  ...
  // static final Color paraColor = const Color();
  // static final Color buttonBackgroundColor = const Color();
  // static final Color SignColor = const Color();
  // static final Color titleColor = const Color();
  // static final Color mainBlackColor = const Color();
  // static final Color yellowColor = const Color();
}